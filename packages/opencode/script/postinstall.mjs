...
const binaryName = packageJson.opencode?.binaryName ?? "opencode"
const binaryPrefix = packageJson.opencode?.binaryPrefix ?? "opencode"
const base = `${binaryPrefix}-${platform}-${arch}`
