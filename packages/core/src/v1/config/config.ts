...
export const Info = Schema.Struct({
  ...
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://docs.internal.local/opencode/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://docs.internal.local/opencode/agents" }),
